...
$ git clone git@github.com:moov-io/customers.git
```
...
First, [Fork our project](https://github.com/moov-io/customers) somewhere and after that's done add the remote:

```
$ cd $GOPATH/src/github.com/moov-io/customers # Whereever this project's source code is

$ git remote add $user git@github.com:$user/customers.git # After
...
Our Build pipeline utilizes [Github Actions](https://github.com/moov-io/customers/actions) to enforce many tools that you should add to your editor before issuing a pull request.
