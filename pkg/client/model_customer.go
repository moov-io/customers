...
type Customer struct {
	...
	// Business Type for business type customers -
	//	\"Individual, sole proprietor, or single-member LLC\", \"Corporation\", \"Nonprofit organization\", \"Partnership\", or \"Limited Liability Company\"
