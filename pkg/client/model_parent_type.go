...
// ParentType Note if the Parent (of a child resource, e.g. address or phone number) represents a customer or business representative/individual
type ParentType string

// List of CustomerType
const (
	PARENTTYPE_CUSTOMER ParentType = "customer"
	PARENTTYPE_REPRESENTATIVE   ParentType = "representative"
)
